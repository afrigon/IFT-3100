...
#ifndef COMPONENTS_UNDELETABLECOMPONENT_H_
#define COMPONENTS_UNDELETABLECOMPONENT_H_
...
class UndeletableComponent : public AbstractComponent {};

#endif  // COMPONENTS_UNDELETABLECOMPONENT_H_
